...
class DictionaryApp:
    def __init__(self, master):
        ...
        self.words = [
            ...
            {"English": "School", "Thai": "โรงเรียน", "Type": "noun"},
            {"English": "zero", "Thai": "ศูนย์", "Type": "noun"},
            {"English": "Animals", "Thai": "สัตว์", "Type": "noun"},
            {"English": "Hunting", "Thai": "การล่า", "Type": "noun"},
            {"English": "Difference", "Thai": "แตกต่าง", "Type": "noun"},
            {"English": "Skip", "Thai": "ข้าม", "Type": "noun"},
            {"English": "match", "Thai": "ไม้ขีด", "Type": "noun"},
            {"English": "Solve", "Thai": "แก้ปัญหา", "Type": "noun"},
            {"English": "Distance", "Thai": "ระยะทาง", "Type": "noun"},
            {"English": "Habitat", "Thai": "ที่อยู่อาศัย", "Type": "noun"},
            {"English": "Aerial", "Thai": "อยู่ในอากาศ", "Type": "noun"},
            {"English": "Terrestrial", "Thai": "บนพื้นดิน", "Type": "noun"},
            {"English": "Desert", "Thai": "ทะเลทราย", "Type": "noun"},
            {"English": "Branch", "Thai": "กิ่งไม้", "Type": "noun"},
            {"English": "Reproduce", "Thai": "แพร่พันธุ์", "Type": "noun"},
            {"English": "Forest", "Thai": "ป่า", "Type": "noun"},
            {"English": "Grassland", "Thai": "ทุ่งหญ้า", "Type": "noun"},
